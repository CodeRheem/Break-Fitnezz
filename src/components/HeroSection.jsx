...
export default function HeroSection(){   
    return(
        <div className="relative h-[120vh] md:h-[130vh] w-full overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/60">
                <div className="absolute inset-0 bg-linear-to-b from-transparent via-transparent to-black">
                    <div className="relative z-10 h-full flex flex-col">
                        ...
                        {/* Header */}
                        <header className="flex justify-between items-center px-4 md:px-8 py-4 md:py-6 bg-black/60">
                            <p className="text-xl md:text-2xl font-bold text-white font-serif">
                            ...
                            <nav className="hidden md:block">
                                <ul className="flex gap-6 text-amber-50 drop-shadow-[0_2px_8px_rgba(16,185,129,0.8)] font-medium font-[cursive]">
                                    <li><a href="#classes" className="hover:text-green-600 transition-colors">Classes</a></li>
                                    <li><a href="#membership" className="hover:text-green-600 transition-colors">Membership</a></li>
                                    <li><a href="#trainers" className="hover:text-green-600 transition-colors">Trainers</a></li>
                                    <li><a href="#testimonials" className="hover:text-green-600 transition-colors">Testimonials</a></li>
                                    <li><a href="#contactUs" className="hover:text-green-600 transition-colors">Contact Us</a></li>
                                </ul>
                            </nav>
                        </header>
                        ...
                        <div className="flex-1 flex items-center justify-center px-4 text-center">
                            <div className="text-white p-3">
                                ...
                                <p className="text-xs md:text-sm mb-8 max-w-lg mx-auto">
                                    Join Break Fitness to push past your limits and reach new heights in your fitness journey. 
